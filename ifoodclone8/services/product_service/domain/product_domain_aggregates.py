...
=========================
Agregados para o domínio product_domain.
Agregado é um cluster de entidades e value objects com raiz (root entity).
"""

from uuid import UUID
from .product_domain_entities import Product


class Product_domainAggregate:
    """
    Agregado raiz para o domínio product_domain.
