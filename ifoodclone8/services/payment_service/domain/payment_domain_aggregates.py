...
=========================
Agregados para o domínio payment_domain.
Agregado é um cluster de entidades e value objects com raiz (root entity).
"""

from uuid import UUID
from .payment_domain_entities import Payment


class Payment_domainAggregate:
    """
    Agregado raiz para o domínio payment_domain.
